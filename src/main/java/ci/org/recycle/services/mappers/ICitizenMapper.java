...
import ci.org.recycle.services.dtos.responses.CitizenResponseDTO;
...
public interface ICitizenMapper {
    ...
    @Mappings({
            ...
            @Mapping(source = "dto.loyaltyPoint", target = "loyaltyPoint"),
            @Mapping(source = "dto.citizenType", target = "citizenType"),
    ...
    Citizen toEntity(CitizenResponseDTO dto);


    @Mappings({
            @Mapping(source = "entity.id", target = "id"),
            @Mapping(source = "entity.loyaltyPoint", target = "loyaltyPoint"),
            @Mapping(source = "entity.citizenType", target = "citizenType"),
    ...
    CitizenResponseDTO toDto(Citizen entity);
}
